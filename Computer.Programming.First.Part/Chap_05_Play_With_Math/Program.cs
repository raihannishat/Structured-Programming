...
namespace Chap_05_Play_With_Math
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Total amount: {0:0.00}", total_amount);
            Console.WriteLine("Monthly amount: {0:0.00}", monthly_amount);
            */
            #endregion
            ...
            */
            ...
            Console.WriteLine("The temperature in farenheit is: {0:0.00}", farenheit);
            */
            #endregion
            ...
            Console.WriteLine("The temperature in farenheit is: {0:0.00}", celsius);
            */
            #endregion
